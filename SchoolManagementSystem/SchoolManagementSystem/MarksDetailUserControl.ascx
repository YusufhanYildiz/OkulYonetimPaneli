            ...
            <div class="col-md-12">
                <asp:GridView ID="GridView1" runat="server" CssClass="table table-hover table-bordered" EmptyDataText="Herhangi bir kayıt yok" AutoGenerateColumns="False" AllowPaging="true" PageSize="8" OnPageIndexChanging="GridView1_PageIndexChanging">
                    <Columns>
                        ...
                        <asp:BoundField DataField="ExamId" HeaderText="DersId">
                            <ItemStyle HorizontalAlign="Center" />
                        </asp:BoundField>
                        ...
                        <asp:BoundField DataField="RollNo" HeaderText="Öğrenci Numarası">
                            <ItemStyle HorizontalAlign="Center" />
                        </asp:BoundField>

                        <asp:BoundField DataField="TotalMarks" HeaderText="Notlar">
                            <ItemStyle HorizontalAlign="Center" />
                        </asp:BoundField>

                        <asp:BoundField DataField="OutOfMarks" HeaderText="Performans Notları">
                            <ItemStyle HorizontalAlign="Center" />
                        </asp:BoundField>
                    </Columns>
