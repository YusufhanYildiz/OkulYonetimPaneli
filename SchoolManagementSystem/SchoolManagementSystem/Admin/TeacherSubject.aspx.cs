    ...
    public partial class TeacherSubject : System.Web.UI.Page
    {
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    lblMs.Text = "Girilen <b>Öğretmen Dersleri<b> Sınıf İçin Zaten Mevcut";
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                {
                    DropDownList ddlClass = (DropDownList)e.Row.FindControl("ddlSubjectGv");
                    ...
                    DataTable dataTable = fn.Fetch(@"Select ts.Id, ts.ClassId, ts.SubjectId, s.SubjectName from TeacherSubject ts inner join Subject s on ts.SubjectId = s.SubjectId = s.SubjectId where ts.Id = '"+ teacherSubjectId +"' ");
